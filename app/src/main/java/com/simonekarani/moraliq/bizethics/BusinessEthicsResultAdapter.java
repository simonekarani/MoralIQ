...
public class BusinessEthicsResultAdapter extends ArrayAdapter<BusinessEthicsResult> {
    private final static String WRONG_KEYWORD = " (Wrong)";

    private ArrayList<BusinessEthicsResult> dataSet;
    Context mContext;
    ...
    public BusinessEthicsResultAdapter(ArrayList<BusinessEthicsResult> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BusinessEthicsResult dataModel = getItem(position);
        ...
        int dataListIdx = dataModel.getBizEthicsIdx();
