...
public class MedicalEthicalData {
    ...
    public static MedicalEthicalModel MedEthicalData1  = new MedicalEthicalModel(MED_ETHICAL_1,  22, R.drawable.med_ethic1,  24, 2, MedEthicalAnalysis1, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData2  = new MedicalEthicalModel(MED_ETHICAL_2,  22, R.drawable.med_ethic2,  24, 0, MedEthicalAnalysis2, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData3  = new MedicalEthicalModel(MED_ETHICAL_3,  22, R.drawable.med_ethic3,  24, 0, MedEthicalAnalysis3, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData4  = new MedicalEthicalModel(MED_ETHICAL_4,  22, R.drawable.med_ethic4,  24, 0, MedEthicalAnalysis4, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData5  = new MedicalEthicalModel(MED_ETHICAL_5,  22, R.drawable.med_ethic5,  19, 1, MedEthicalAnalysis5, "Yes, unless someone is going to die immediately, I don't tell them how bad it is", "No, I soften it and give hope even if there's little chance", "No, I tell it exactly as I see it", "It Depends");
    ...
    public static MedicalEthicalModel MedEthicalData9  = new MedicalEthicalModel(MED_ETHICAL_9,  22, R.drawable.med_ethic9,  24, 0, MedEthicalAnalysis9, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData10 = new MedicalEthicalModel(MED_ETHICAL_10, 19, R.drawable.med_ethic10, 24, 0, MedEthicalAnalysis10, "Yes", "No", "It Depends");
    ...
    public static MedicalEthicalModel MedEthicalData14 = new MedicalEthicalModel(MED_ETHICAL_14, 20, R.drawable.med_ethic14, 24, 2, MedEthicalAnalysis14, "Yes", "No", "It Depends");
    ...
    public static MedicalEthicalModel MedEthicalData16 = new MedicalEthicalModel(MED_ETHICAL_16, 22, R.drawable.med_ethic16, 24, 0, MedEthicalAnalysis16, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData17 = new MedicalEthicalModel(MED_ETHICAL_17, 22, R.drawable.med_ethic17, 24, 0, MedEthicalAnalysis17, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData18 = new MedicalEthicalModel(MED_ETHICAL_18, 22, R.drawable.med_ethic18, 20, 2, MedEthicalAnalysis18, "Yes, while that patient is still a patient", "Yes, but not until at least 6 months after they stopped being a patient", "No", "It Depends");
    ...
    public static MedicalEthicalModel MedEthicalData20 = new MedicalEthicalModel(MED_ETHICAL_20, 22, R.drawable.med_ethic20, 24, 0, MedEthicalAnalysis20, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData21 = new MedicalEthicalModel(MED_ETHICAL_21, 22, R.drawable.med_ethic21, 24, 2, MedEthicalAnalysis21, "Yes", "No", "It Depends");
    ...
    public static MedicalEthicalModel MedEthicalData24 = new MedicalEthicalModel(MED_ETHICAL_24, 22, R.drawable.med_ethic24, 24, 2, MedEthicalAnalysis24, "Yes", "No", "It Depends");
