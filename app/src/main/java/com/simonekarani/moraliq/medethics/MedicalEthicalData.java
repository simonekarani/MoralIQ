...
public class MedicalEthicalData {
    ...
    public static MedicalEthicalModel MedEthicalData1  = new MedicalEthicalModel(MED_ETHICAL_1,  21, R.drawable.med_ethic1,  22, 2, MedEthicalAnalysis1, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData2  = new MedicalEthicalModel(MED_ETHICAL_2,  21, R.drawable.med_ethic2,  22, 0, MedEthicalAnalysis2, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData3  = new MedicalEthicalModel(MED_ETHICAL_3,  21, R.drawable.med_ethic3,  22, 0, MedEthicalAnalysis3, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData4  = new MedicalEthicalModel(MED_ETHICAL_4,  21, R.drawable.med_ethic4,  22, 0, MedEthicalAnalysis4, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData5  = new MedicalEthicalModel(MED_ETHICAL_5,  21, R.drawable.med_ethic5,  18, 1, MedEthicalAnalysis5, "Yes, unless someone is going to die immediately, I don't tell them how bad it is", "No, I soften it and give hope even if there's little chance", "No, I tell it exactly as I see it", "It Depends");
    public static MedicalEthicalModel MedEthicalData6  = new MedicalEthicalModel(MED_ETHICAL_6,  21, R.drawable.med_ethic6,  22, 1, MedEthicalAnalysis6, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData7  = new MedicalEthicalModel(MED_ETHICAL_7,  21, R.drawable.med_ethic7,  22, 1, MedEthicalAnalysis7, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData8  = new MedicalEthicalModel(MED_ETHICAL_8,  21, R.drawable.med_ethic8,  22, 1, MedEthicalAnalysis8, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData9  = new MedicalEthicalModel(MED_ETHICAL_9,  21, R.drawable.med_ethic9,  22, 0, MedEthicalAnalysis9, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData10 = new MedicalEthicalModel(MED_ETHICAL_10, 17, R.drawable.med_ethic10, 22, 0, MedEthicalAnalysis10, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData11 = new MedicalEthicalModel(MED_ETHICAL_11, 21, R.drawable.med_ethic11, 22, 1, MedEthicalAnalysis11, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData12 = new MedicalEthicalModel(MED_ETHICAL_12, 21, R.drawable.med_ethic12, 22, 1, MedEthicalAnalysis12, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData13 = new MedicalEthicalModel(MED_ETHICAL_13, 21, R.drawable.med_ethic13, 19, 1, MedEthicalAnalysis13, "Yes, in order to get a patient the services, such as drugs, treatment, or hospital coverage", "Yes, in order to bring in more revenue", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData14 = new MedicalEthicalModel(MED_ETHICAL_14, 19, R.drawable.med_ethic14, 22, 2, MedEthicalAnalysis14, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData15 = new MedicalEthicalModel(MED_ETHICAL_15, 19, R.drawable.med_ethic15, 22, 1, MedEthicalAnalysis15, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData16 = new MedicalEthicalModel(MED_ETHICAL_16, 21, R.drawable.med_ethic16, 22, 0, MedEthicalAnalysis16, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData17 = new MedicalEthicalModel(MED_ETHICAL_17, 21, R.drawable.med_ethic17, 22, 0, MedEthicalAnalysis17, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData18 = new MedicalEthicalModel(MED_ETHICAL_18, 21, R.drawable.med_ethic18, 19, 2, MedEthicalAnalysis18, "Yes, while that patient is still a patient", "Yes, but not until at least 6 months after they stopped being a patient", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData19 = new MedicalEthicalModel(MED_ETHICAL_19, 20, R.drawable.med_ethic19, 22, 1, MedEthicalAnalysis19, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData20 = new MedicalEthicalModel(MED_ETHICAL_20, 21, R.drawable.med_ethic20, 22, 0, MedEthicalAnalysis20, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData21 = new MedicalEthicalModel(MED_ETHICAL_21, 21, R.drawable.med_ethic21, 22, 2, MedEthicalAnalysis21, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData22 = new MedicalEthicalModel(MED_ETHICAL_22, 21, R.drawable.med_ethic22, 22, 1, MedEthicalAnalysis22, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData23 = new MedicalEthicalModel(MED_ETHICAL_23, 21, R.drawable.med_ethic23, 22, 1, MedEthicalAnalysis23, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData24 = new MedicalEthicalModel(MED_ETHICAL_24, 21, R.drawable.med_ethic24, 22, 2, MedEthicalAnalysis24, "Yes", "No", "It Depends");
    public static MedicalEthicalModel MedEthicalData25 = new MedicalEthicalModel(MED_ETHICAL_25, 21, R.drawable.med_ethic25, 22, 1, MedEthicalAnalysis25, "Yes", "No", "It Depends");
